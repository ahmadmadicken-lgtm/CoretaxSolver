...
const PLAYBOOKS = [
  ...
  { id: 'PB015', title: 'Perubahan KLU Utama WP OP',                   file: 'playbooks/PB015.json' },
  { id: 'PB016', title: 'Melihat Buku Besar & Riwayat Pembayaran',     file: 'playbooks/PB016.json' },
  { id: 'PB017', title: 'Pemindahbukuan (Pbk)',                         file: 'playbooks/PB017.json' },
  { id: 'PB018', title: 'Pengajuan SKF (Surat Keterangan Fiskal)',      file: 'playbooks/PB018.json' },
  { id: 'PB019', title: 'Perpanjangan Waktu Penyampaian SPT Tahunan',   file: 'playbooks/PB019.json' },
  { id: 'PB020', title: 'Pengajuan Pengurangan Angsuran PPh Pasal 25',  file: 'playbooks/PB020.json' },
  { id: 'PB021', title: 'Permohonan Pengukuhan PKP',                    file: 'playbooks/PB021.json' },
  { id: 'PB022', title: 'Pencabutan Pengukuhan PKP',                    file: 'playbooks/PB022.json' },
  { id: 'PB023', title: 'Penghapusan NPWP WP OP',                       file: 'playbooks/PB023.json' },
  { id: 'PB024', title: 'Aktivasi NIK sebagai NPWP di Coretax',         file: 'playbooks/PB024.json' },
  { id: 'PB025', title: 'Perubahan Status WP — Penetapan Non-Aktif',    file: 'playbooks/PB025.json' },
  { id: 'PB026', title: 'Laporan Realisasi Investasi (Bebas PPh Dividen)', file: 'playbooks/PB026.json' },
  { id: 'PB027', title: 'Pengaktifan Kembali WP Non-Aktif',             file: 'playbooks/PB027.json' },
  { id: 'PB028', title: 'Perubahan Data Kontak WP (Email & Nomor HP)',   file: 'playbooks/PB028.json' },
  { id: 'PB029', title: 'Melihat & Mengunduh Dokumen Saya',              file: 'playbooks/PB029.json' },
  { id: 'PB030', title: 'Cara Impersonating (Kuasa WP di Coretax)',       file: 'playbooks/PB030.json' },
  { id: 'PB031', title: 'Penambahan & Perubahan Rekening Bank WP',        file: 'playbooks/PB031.json' },
  { id: 'PB032', title: 'Cek Status Permohonan (Kasus Saya)',             file: 'playbooks/PB032.json' },
  { id: 'PB033', title: 'Konfirmasi Status Wajib Pajak (AS.01-02)',       file: 'playbooks/PB033.json' },
  { id: 'PB034', title: 'Pendaftaran NPWP WP OP Non-Penduduk (WNA)',      file: 'playbooks/PB034.json' },
  { id: 'PB035', title: 'Penunjukan Wakil/Kuasa Wajib Pajak',            file: 'playbooks/PB035.json' },
  { id: 'PB036', title: 'Pencabutan Wakil/Kuasa Wajib Pajak',            file: 'playbooks/PB036.json' },
  { id: 'PB037', title: 'Kode Billing atas Tagihan Pajak (STP/SKPKB)',   file: 'playbooks/PB037.json' },
...
const HARGA_PB = {
  ...
  'PB015': { tier: 'tier2', keterangan: 'KLU Utama WP berhasil diperbarui sesuai jenis usaha terkini di Coretax' },
  'PB016': { tier: 'tier1', keterangan: 'riwayat transaksi dan saldo pajak WP berhasil dibaca dan transkrip dapat diunduh' },
  'PB017': { tier: 'tier2', keterangan: 'Permohonan Pemindahbukuan berhasil terkirim dan kredit pajak berpindah sesuai tujuan' },
  'PB018': { tier: 'tier2', keterangan: 'SKF berhasil diterbitkan dan tersedia di Daftar Fasilitas Saya untuk diunduh' },
  'PB019': { tier: 'tier2', keterangan: 'perpanjangan waktu SPT Tahunan berhasil diajukan dan BPE perpanjangan diterima' },
  'PB020': { tier: 'tier2', keterangan: 'SK Pengurangan Angsuran PPh Pasal 25 diterbitkan dan angsuran baru berlaku sesuai SK' },
  'PB021': { tier: 'tier2', keterangan: 'Surat Pengukuhan PKP diterbitkan dan WP mendapat akses e-Faktur serta SPT Masa PPN' },
  'PB022': { tier: 'tier2', keterangan: 'Surat Pencabutan PKP diterbitkan dan WP tidak lagi wajib memungut PPN' },
  'PB023': { tier: 'tier2', keterangan: 'SK Penghapusan NPWP diterbitkan dan NPWP WP dinyatakan tidak aktif secara resmi' },
  'PB024': { tier: 'tier2', keterangan: 'NIK berhasil diaktifkan sebagai NPWP dan dapat digunakan untuk seluruh keperluan perpajakan' },
  'PB025': { tier: 'tier2', keterangan: 'Status WP ditetapkan Non-Aktif dan NPWP dapat diaktifkan kembali jika kondisi berubah' },
  'PB026': { tier: 'tier3', keterangan: 'Laporan Realisasi Investasi berhasil disampaikan dan fasilitas bebas PPh dividen berlaku' },
  'PB027': { tier: 'tier2', keterangan: 'Status WP berhasil diaktifkan kembali dan Surat Pengaktifan Kembali diterbitkan' },
  'PB028': { tier: 'tier2', keterangan: 'Data kontak WP berhasil diperbarui dan email/HP baru langsung aktif di sistem DJP' },
  'PB029': { tier: 'tier1', keterangan: 'Dokumen perpajakan berhasil ditemukan dan diunduh dari Dokumen Saya' },
  'PB030': { tier: 'tier1', keterangan: 'Konsultan berhasil masuk mode impersonating dan dapat mengerjakan kewajiban klien' },
  'PB031': { tier: 'tier2', keterangan: 'Rekening bank berhasil terdaftar dan tersedia untuk pengembalian pajak di Coretax' },
  'PB032': { tier: 'tier1', keterangan: 'Status permohonan berhasil dipantau dan progress terkini dapat diketahui' },
  'PB033': { tier: 'tier1', keterangan: 'Konfirmasi Status WP berhasil diperoleh dan kepatuhan perpajakan WP dapat diverifikasi' },
  'PB034': { tier: 'tier2', keterangan: 'NPWP 16 digit WNA berhasil diterbitkan DJP dan dapat digunakan untuk perpajakan di Indonesia' },
  'PB035': { tier: 'tier2', keterangan: 'Penunjukan kuasa berhasil dan konsultan dapat impersonating ke akun WP' },
  'PB036': { tier: 'tier2', keterangan: 'Pencabutan kuasa berhasil dan konsultan tidak lagi bisa akses akun WP' },
  'PB037': { tier: 'tier1', keterangan: 'Kode Billing atas tagihan/ketetapan pajak berhasil dibuat dan siap dibayar' },
